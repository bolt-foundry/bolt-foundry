...
export const CfDsModal = forwardRef<ModalHandles, ModalOptions>(
  (
    {
      children,
          ...
          >
            ...
            {onSave != null && (
              <div style={styles.footer}>
                <CfDsButton text="Cancel" kind="outline" onClick={onClose} />
                <CfDsButton text="Save" kind="primary" onClick={onSave} />
              </div>
            )}
          </div>
        </div>,
