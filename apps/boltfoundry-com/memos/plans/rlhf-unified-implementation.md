...
This plan unifies our RLHF implementation approach, building on the completed eval scaffolding to create a focused interface for collecting human feedback on AI evaluations. We prioritize shipping a working MVP that demonstrates the core value proposition: humans providing feedback on AI-generated evaluations to improve model performance.

The implementation is organized into four phases that can be completed sequentially as time permits.
...
1. **Backend RLHF Data Model**
   - All 5 node types implemented: BfDeck, BfGrader, BfSample, BfGraderResult, BfSampleFeedback
