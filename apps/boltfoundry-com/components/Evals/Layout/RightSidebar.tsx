...
export function RightSidebar() {
  ...
  const renderDeckCreationContent = () => {
    return (
      <>
        <h3 style={{ marginBottom: "1rem", color: "#ccc" }}>Your Grader System</h3>
        ...
        <div className="deck-creation-progress">
          <div className="generated-card">
            ...
            <p style={{ fontSize: "0.875rem", color: "#999" }}>Validates syntax and logic</p>
          </div>
          ...
          <div className="generated-card">
            ...
            <p style={{ fontSize: "0.875rem", color: "#999" }}>Checks for clear, simple explanations</p>
          </div>
          ...
          <div className="generated-card">
            ...
            <p style={{ fontSize: "0.875rem", color: "#999" }}>Ensures responses solve the problem</p>
          </div>
          ...
          <div className="generated-card">
            ...
            <p style={{ fontSize: "0.875rem", color: "#999" }}>Evaluates clarity and completeness</p>
          </div>
        </div>
      </>
    );
      ...
      <div className={sidebarClass}>
        <div className="eval-sidebar-content">
          ...
          <div className="eval-sidebar-body">
            {chatMode === "createDeck" && rightSidebarContent === "Deck Creation"
