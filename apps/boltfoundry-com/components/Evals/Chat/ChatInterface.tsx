            ...
            content: [
              {
                type: "text",
                content:
                  "<p style='font-weight: bold; margin-bottom: 0.5rem;'>Welcome to EvalForge! I'm your AI evaluation assistant.</p><p>I'll help you build a robust evaluation system for your LLM. Let's start with understanding what you're trying to evaluate.</p>",
              },
              {
                type: "choices",
