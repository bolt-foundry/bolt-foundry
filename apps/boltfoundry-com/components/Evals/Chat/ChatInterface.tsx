...
export function ChatInterface({ sessionId }: ChatInterfaceProps) {
  const { openRightSidebar, chatMode, chatBackTarget, exitChatMode } = useEvalContext();
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                content: "<p style='font-weight: bold; margin-bottom: 0.5rem;'>Welcome to EvalForge! I'm your AI evaluation assistant.</p><p>I'll help you build a robust evaluation system for your LLM. Let's start with understanding what you're trying to evaluate.</p>"
              },
              {
                type: "choices",
                ...
                choices: [
                  ...
                  { id: "customer", label: "Customer service chatbot", icon: "🔬" },
                  { id: "creative", label: "Creative writing helper", icon: "🎨" },
  ...
  const handleDeckCreationResponse = (userInput: string) => {
    setTimeout(() => {
      let assistantContent: MessageContentBlock[] = [];
      ...
      if (deckCreationStep === 1) {
        ...
        const graders = deckCreationData.useCase === "coding"
          ? [
              { name: "Code Accuracy", description: "Validates syntax and logic", status: "building" },
              { name: "Language Simplicity", description: "Checks for clear, simple explanations", status: "building" },
              { name: "Helpfulness", description: "Ensures responses solve the problem", status: "building" },
              { name: "Explanation Quality", description: "Evaluates clarity and completeness", status: "building" },
            ]
          : [
              { name: "Accuracy", description: "Validates factual correctness", status: "building" },
              { name: "Helpfulness", description: "Ensures responses are useful", status: "building" },
              { name: "Clarity", description: "Checks for clear communication", status: "building" },
            ];
        ...
        assistantContent = [
          {
            type: "text",
            content: "<p>Excellent! I can see your assistant emphasizes clarity, accuracy, and helpfulness. Let me create evaluation graders tailored to these goals.</p>"
          },
          {
            type: "code",
