...
import entrypoint from "apps/boltFoundry/__generated__/__isograph/Mutation/RegistrationOptions/entrypoint.ts";
import mutation from "apps/boltFoundry/__generated__/__isograph/Mutation/Register/entrypoint.ts";
