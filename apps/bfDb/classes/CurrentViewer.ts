...
export class CurrentViewer extends GraphQLObjectBase {
  ...
  /**
   * Create a logged out viewer for testing
   */
  static makeLoggedOutCv(): CurrentViewer {
  ...
  /**
   * Create viewer from request
   * This version handles cookies and sets response headers
   */
  static createFromRequest(
    ...
    // For now, just return a logged out viewer
    // In a real implementation, this would verify JWT tokens from cookies
    return new CurrentViewerLoggedOut();
  }
