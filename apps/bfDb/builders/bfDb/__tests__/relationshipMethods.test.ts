...
Deno.test.ignore(
  ...
  async () => {
    ...
    await withIsolatedDb(async () => {
      ...
      await (book as any).deleteAuthor({ deleteNode: true });
...
Deno.test("Generated relationship methods - multiple relationships", async () => {
  await withIsolatedDb(async () => {
    ...
    const reviewer = await TestAuthor.__DANGEROUS__createUnattached(cv, {
      name: "Tech Reviewer",
...
Deno.test("Generated relationship methods - no relationships defined", async () => {
  await withIsolatedDb(async () => {
    ...
    assertEquals(
      (author as any).findBook,
      undefined,
      "Should not have findBook",
    );
    assertEquals(
      (author as any).createBook,
      undefined,
      "Should not have createBook",
    );
    assertEquals(
      (author as any).deleteBook,
      undefined,
