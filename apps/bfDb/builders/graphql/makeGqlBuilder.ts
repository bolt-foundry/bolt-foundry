...
// Allow Promise returns for circular references
// We use 'any' here intentionally to support test mocks that return Promise.resolve(class {})
// deno-lint-ignore no-explicit-any
type GraphQLObjectClassOrPromise = GraphQLObjectClass | Promise<any>;
  ...
  const builder: GqlBuilder<R> = {
    ...
    object(name, targetOrTypeOrOpts, extraOpts) {
      ...
      if (typeof targetOrTypeOrOpts === "string") {
        ...
        try {
          const targetResult = targetOrTypeOrOpts();
