...
export class BfOrganization extends BfNode<InferProps<typeof BfOrganization>> {
  ...
  async addDemoDeck(): Promise<void> {
    ...
    // The createDecks method is dynamically generated by the relationship system
    type ThisWithCreateDecks = this & {
      createDecks: (props: typeof deckProps) => Promise<BfDeck>;
    };
    await (this as unknown as ThisWithCreateDecks).createDecks(deckProps);
  }
}
