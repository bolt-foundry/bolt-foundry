import { toBfGid } from "../classes/BfNodeIds.ts";
import { generateUUID } from "lib/generateUUID.ts";
import type { BfCurrentViewer } from "../classes/BfCurrentViewer.ts";
import type { BfMetadataBase } from "../classes/BfNodeBase.ts";
import type { BfMetadataEdgeBase } from "../classes/BfEdgeBase.ts";
