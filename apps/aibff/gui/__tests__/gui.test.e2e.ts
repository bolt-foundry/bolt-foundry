...
Deno.test.ignore("aibff gui --dev loads successfully with routing and Isograph", async () => {
...
Deno.test.ignore("debug tool call execution should replace grader deck content", async () => {
  // Start the aibff gui dev server
