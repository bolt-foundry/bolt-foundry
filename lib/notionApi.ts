  ...
  const filteredData = data.results.map(
    (contentBlock: NotionBlogPostContentObject) => {
      ...
      switch (contentBlock.type) {
        ...
        case "heading_2": {
          let textString = "";
          contentBlock.heading_2.rich_text.forEach((rich_text) => {
            textString += rich_text.plain_text;
          });
          return {
            id: contentBlock.id,
        ...
        case "heading_3": {
          let textString = "";
          contentBlock.heading_3.rich_text.forEach((rich_text) => {
            textString += rich_text.plain_text;
          });
          return {
            id: contentBlock.id,
        ...
        case "heading_4": {
          let textString = "";
          contentBlock.heading_4.rich_text.forEach((rich_text) => {
            textString += rich_text.plain_text;
          });
          return {
            id: contentBlock.id,
            type: contentBlock.type,
            RichText: contentBlock.heading_4.rich_text,
            color: contentBlock.heading_4.color,
          };
        }
        case "paragraph": {
          let textString = "";
