...
verifiable LLM systems. It uses Identity Cards as the core abstraction -
verified, tested units of LLM functionality that can be composed into larger
systems. The platform is built with Deno as the runtime, React for the UI, and
...
The bfDb system provides a flexible, type-safe database abstraction layer with
support for multiple backends. The core components are:
