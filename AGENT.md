...
- **Programming Paradigm**: Prefer functional approaches to code over object-oriented programming (OOP) except when modeling data. Use pure functions, avoid unnecessary classes, and minimize side effects.
