...
import { BfDsListItem, type BfDsListItemHandle } from "packages/bfDs/components/BfDsListItem.tsx";
...
export function BlogRevision({ revision }: Props) {
  ...
  return (
    <BfDsListItem
      ...
      expandCallback={(newExpandingState) =>
        handleExpanding(newExpandingState)}
    />
  );
}
