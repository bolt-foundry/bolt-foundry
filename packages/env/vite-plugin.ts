import type { Plugin } from "npm:vite@5";
...
export function boltFoundryEnvPlugin(): Plugin {
  return {
    ...
    config(config, { mode }) {
      ...
      defineEntries["import.meta.env.PROD"] = mode === "production" ? "true" : "false";
      defineEntries["import.meta.env.DEV"] = mode === "development" ? "true" : "false";
      defineEntries["import.meta.env.SSR"] = "false";
      defineEntries["import.meta.env.BASE_URL"] = JSON.stringify(config.base || "/");
