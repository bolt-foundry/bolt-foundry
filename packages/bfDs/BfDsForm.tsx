...
> = TAdditionalFormElementProps & {
  id: string;
  title: string;
  validator?: (data: TData) => FormError | undefined;
};

function BfDsTextInput({ id, title, validator }: BfDsFormElementProps) {
...
export function Example() {
  return (
    <BfDsForm onSubmit={exampleOnSubmit} initialData={exampleInitialFormData}>
      ...
      <BfDsTextInput id="email" title="What is your email?" validator="email" />
