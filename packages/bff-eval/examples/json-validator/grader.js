...
module.exports = makeGraderDeckBuilder("json-validator")
  ...
  .card(
    "scoring", 
    c =>
      c.spec("Perfect (3): Valid JSON with exact structure and all data correctly extracted")
        .spec("Good (2): Valid JSON with minor issues (extra fields, slightly different structure)")
        .spec("Acceptable (1): Valid JSON but missing some data or has minor errors")
