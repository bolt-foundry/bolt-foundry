...
- **Fluent Builder API**: Chain method calls to construct structured prompts
  with full TypeScript type safety
- **Persona Builder**: Define AI personas with description, traits, and
  constraints using nested builder pattern
...
- **Phase 2**: Persona API with nested builders for description, traits,
  constraints
