...
engineering from brittle text strings into structured, composable cards with examples and specifications. Instead of concatenating strings and hoping for the
...
- **Client API**: Use `boltFoundryClient.createCard()` to create named
  cards with full TypeScript type safety
- **Cards**: Define AI cards with personas, descriptions, traits,
