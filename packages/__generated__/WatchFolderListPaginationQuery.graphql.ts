...
export type WatchFolderListPaginationQuery$variables = {
  after?: string | null | undefined;
  first?: number | null | undefined;
  id: string;
};
export type WatchFolderListPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"WatchFolderList_bfOrganization">;
  } | null | undefined;
};
export type WatchFolderListPaginationQuery = {
  response: WatchFolderListPaginationQuery$data;
  variables: WatchFolderListPaginationQuery$variables;
};
