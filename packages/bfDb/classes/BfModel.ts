...
> {
  ...
  >(
    ...
    currentViewer: BfCurrentViewer,
    bfGid: BfAnyid,
    dangerousOptions = { I_WANT_TO_LOAD_THIS_DANGEROUSLY_AND_I_KNOW_ITS_PRIVACY_UNSAFE: false}
  ): Promise<
    InstanceType<TThis> & BfBaseModelMetadata<TCreationMetadata>
  > {
    ...
    if (currentViewer instanceof IBfCurrentViewerInternalAdminOmni || dangerousOptions.I_WANT_TO_LOAD_THIS_DANGEROUSLY_AND_I_KNOW_ITS_PRIVACY_UNSAFE === true) {
