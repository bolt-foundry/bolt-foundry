...
export class BfNotificationSubscription
  extends BfNode<BfNotificationSubscriptionRequiredProps> {
  afterCreate() {
  ...
  async subscribeToGoogle() {
    const url =
      `https://www.googleapis.com/drive/v3/files/${this.resourceId}/watch`;
    const payload = {
      id: "unique-channel-id-333333", // Your unique channel ID
      type: "web_hook",
      address:
        "https://3761a1ed-8bad-41d2-bbbd-07e446cba0d5-00-1ufeqn8lflt0u.riker.replit.dev/google/drive/webhook",
