...
2. **Credential Management**
   - Copy necessary authentication files into container at runtime
   - Handle SSH keys and git/sapling credentials securely
   - Ensure proper file ownership and permissions within container
...
- **Container Build Validation**: Existing GitHub Actions CI automatically validates Nix-based container builds
- **Multi-Platform Testing**: CI runs on Ubuntu, with Nix providing consistent environment
- **Automated Testing**: All container builds tested on every PR via `.github/workflows/ci.yml`
- **Registry Integration**: Built containers can be pushed to GitHub Container Registry (ghcr.io)
...
- **CI Integration**: Container image building validated automatically via GitHub Actions

### Phase 2: Claude Code Integration

- Container orchestration and lifecycle management
- Interactive terminal I/O passthrough
- Credential copying for authentication and credentials
