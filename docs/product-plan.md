...
**Target Audience**: Private beta with invited developers and waitlist, transitioning from individually onboarded partners to automated onboarding at scale
...
- Private Beta (0.5-0.7) → Product discovery, automation, and marketing foundation
