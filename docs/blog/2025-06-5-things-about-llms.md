author: Dan Sisco
date: 2025-06-05
title: 5 things about LLM prompts we think everyone should know
description: Most teams are building LLM prompts wrong. This post describes how to build reliable LLM systems.
published: true
slug: 5-things-about-llms
---
...
Building evals from scratch is freaking hard, but this structure lays the
...
showing which parts of your prompt are doing the heavy lifting.
...
This is impossible with traditional prompts stuffed with context, instructions,
and examples. Developers are stuck trying to guess which buried clause caused
...
[20% to 100% reliability](velvet-case-study) in less than an hour.
