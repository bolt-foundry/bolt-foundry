...
export const callAPI = async (
  ...
  // const llmInterfaceClaude = new ChatAnthropic({
  ...
  // const jsonLlm = llmInterface.bind({response_format: {"type": "json_object"}})
...
const createSystemMessage = () => {
  ...
  // const content = sample1.content.map((word) => word.word).join(" ");
  // "sample1: {sample1.content}\n\nsampl2: {sample2.content}\n\nsample3: {sample3.content}\n\nsample..."
...
- Contain the following keys:
  ...
  - "confidence": A confidence rating from 0 to 1, where 0 doesn't relate to the prompt and 1 relates best. If the rationale is not clear, the confidence should be 0.
