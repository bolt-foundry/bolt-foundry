...
import { fetchConfigurationVariable, fetchPrivateConfigurationVariable, getConfigurationVariable } from "@bolt-foundry/get-configuration-var";
...
async function generateCommitMessage(
  ...
  const OPENAI_API_KEY = await fetchPrivateConfigurationVariable("OPENAI_API_KEY");
