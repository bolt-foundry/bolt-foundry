 ...
 */
function compareFiles(filePath: string, originalContent: string, newContent: string): boolean {
...
export async function verifyGeneratedCommand(_: Array<string>): Promise<number> {
  ...
  try {
    ...
    if (allUpToDate) {
      ...
      logger.error("❌ Some generated files are out of date. Run 'bft iso' and 'bft genGqlTypes' to update them.");
    }
