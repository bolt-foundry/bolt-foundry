...
async function processDocsFiles() {
  ...
  const generatedDir = Deno.env.get("GENERATED_DIR") || "apps/boltFoundry/__generated__";
...
async function processMdxFile(sourcePath: string, slug: string, buildDir: string) {
  try {
