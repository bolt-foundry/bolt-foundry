...
export default function HintSystem({ hints, onRequestHint, isLoading = false }: HintSystemProps) {
      ...
      {hints.length > 0 && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-800">
            <strong>Tip:</strong> Try to solve as much as you can before asking for more hints. 
