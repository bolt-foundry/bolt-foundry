...
declare module 'url' {
    ...
    import { ClientRequestArgs } from 'https://esm.sh/v130/@types/node@18.16.19/http.d.ts';
    import { ParsedUrlQuery, ParsedUrlQueryInput } from 'https://esm.sh/v130/@types/node@18.16.19/querystring.d.ts';
    // Input to `url.format`
    interface UrlObject {
...
declare module 'https://esm.sh/v130/@types/node@18.16.19/url.d.ts' {
    export * from 'url';
}
