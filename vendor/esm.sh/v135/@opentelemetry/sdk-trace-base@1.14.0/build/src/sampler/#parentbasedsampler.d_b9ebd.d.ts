import { Context, Link, SpanAttributes, SpanKind } from 'https://esm.sh/v135/@opentelemetry/api@1.4.1/build/src/index.d.ts';
import { Sampler, SamplingResult } from '../Sampler.d.ts';
/**
