import { InstrumentationBase } from 'https://esm.sh/v135/@opentelemetry/instrumentation@0.40.0/build/src/index.d.ts';
import { EventName, UserInteractionInstrumentationConfig } from './types.d.ts';
import { ZoneTypeWithPrototype } from './internal-types.d.ts';
/**
