...
import { type CompletionUsage } from 'https://esm.sh/v135/openai@4.53.0/resources/completions.d.ts';
import { type Completions, type ChatCompletion, type ChatCompletionMessage, type ChatCompletionMessageParam, type ChatCompletionCreateParams } from 'https://esm.sh/v135/openai@4.53.0/resources/chat/completions.d.ts';
import { APIUserAbortError, OpenAIError } from 'https://esm.sh/v135/openai@4.53.0/error.d.ts';
