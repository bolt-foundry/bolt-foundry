import type { InputValues } from "../utils/types/index.d.ts";
import { type StringPromptValueInterface } from "../prompt_values.d.ts";
import { BasePromptTemplate, type TypedPromptInputValues } from "./base.d.ts";
/**
