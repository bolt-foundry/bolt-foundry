import { StructuredToolInterface } from "../tools/index.d.ts";
import { FunctionDefinition, ToolDefinition } from "../language_models/base.d.ts";
import { RunnableToolLike } from "../runnables/base.d.ts";
/**
