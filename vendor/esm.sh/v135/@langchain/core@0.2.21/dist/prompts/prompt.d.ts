...
import type { BasePromptTemplateInput, TypedPromptInputValues } from "./base.d.ts";
import { type TemplateFormat } from "./template.d.ts";
import type { SerializedPromptTemplate } from "./serde.d.ts";
import type { InputValues, PartialValues } from "../utils/types/index.d.ts";
import { MessageContent } from "../messages/index.d.ts";
/**
