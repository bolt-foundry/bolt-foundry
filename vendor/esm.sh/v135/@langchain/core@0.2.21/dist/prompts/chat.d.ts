...
import { AIMessage, HumanMessage, SystemMessage, BaseMessage, ChatMessage, type BaseMessageLike, MessageContent } from "../messages/index.d.ts";
import { type ChatPromptValueInterface } from "../prompt_values.d.ts";
import type { InputValues, PartialValues } from "../utils/types/index.d.ts";
import { Runnable } from "../runnables/base.d.ts";
import { BaseStringPromptTemplate } from "./string.d.ts";
import { BasePromptTemplate, type BasePromptTemplateInput, type TypedPromptInputValues } from "./base.d.ts";
import { PromptTemplateInput, ExtractedFStringParams } from "./prompt.d.ts";
import { ImagePromptTemplate } from "./image.d.ts";
import { TemplateFormat } from "./template.d.ts";
/**
