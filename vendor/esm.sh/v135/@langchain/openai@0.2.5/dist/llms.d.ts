...
import { GenerationChunk, type LLMResult } from "https://esm.sh/v135/@langchain/core@0.2.18/outputs.d.ts";
import { BaseLLM, type BaseLLMParams } from "https://esm.sh/v135/@langchain/core@0.2.18/language_models/llms.d.ts";
import type { AzureOpenAIInput, OpenAICallOptions, OpenAICoreRequestOptions, OpenAIInput, LegacyOpenAIInput } from "./types.d.ts";
import { OpenAIChat, OpenAIChatCallOptions } from "./legacy.d.ts";
