...
import { BSON, BSONRegExp, BSONSymbol, BSONType, Binary, Code, DBRef, Decimal128, DeserializeOptions, Document, Double, Int32, Long, MaxKey, MinKey, ObjectId, ObjectIdLike, SerializeOptions, Timestamp, deserialize, serialize } from "./bson.typings.d.ts";
import type { ConnectionOptions as ConnectionOptions_2 } from "https://esm.sh/v135/@types/node@18.16.19/tls.d.ts";
import type { Socket } from "https://esm.sh/v135/@types/node@18.16.19/net.d.ts";
import type { SrvRecord } from "https://esm.sh/v135/@types/node@18.16.19/dns.d.ts";
import type { TcpNetConnectOpts } from "https://esm.sh/v135/@types/node@18.16.19/net.d.ts";
import type { TLSSocket } from "https://esm.sh/v135/@types/node@18.16.19/tls.d.ts";
import type { TLSSocketOptions } from "https://esm.sh/v135/@types/node@18.16.19/tls.d.ts";
import { Readable, EventEmitter } from "../../platform/PlatformTools.d.ts";
/** @public */
