import { ChatCompletionRequestMessage, CreateChatCompletionRequest, ConfigurationParameters, CreateChatCompletionResponse } from "https://esm.sh/v135/openai@3.3.0/dist/index.d.ts";
import { AzureOpenAIInput, OpenAICallOptions, OpenAIChatInput } from "../types/openai-types.d.ts";
...
export declare class OpenAIChat extends LLM implements OpenAIChatInput, AzureOpenAIInput {
    ...
    _identifyingParams(): {
        ...
        stop?: import("https://esm.sh/v135/openai@3.3.0/dist/index.d.ts").CreateChatCompletionRequestStop | undefined;
