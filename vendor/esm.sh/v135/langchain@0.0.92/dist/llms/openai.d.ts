import { ConfigurationParameters, CreateCompletionRequest, CreateCompletionResponse } from "https://esm.sh/v135/openai@3.3.0/dist/index.d.ts";
import { AzureOpenAIInput, OpenAICallOptions, OpenAIInput } from "../types/openai-types.d.ts";
import type { StreamingAxiosConfiguration } from "../util/axios-types.d.ts";
import { BaseLLM, BaseLLMParams } from "./base.d.ts";
import { LLMResult } from "../schema/index.d.ts";
import { CallbackManagerForLLMRun } from "../callbacks/manager.d.ts";
...
export declare class OpenAI extends BaseLLM implements OpenAIInput, AzureOpenAIInput {
    ...
    _identifyingParams(): {
        ...
        model: string;
        prompt?: import("https://esm.sh/v135/openai@3.3.0/dist/index.d.ts").CreateCompletionRequestPrompt | null | undefined;
        ...
        stop?: import("https://esm.sh/v135/openai@3.3.0/dist/index.d.ts").CreateCompletionRequestStop | null | undefined;
...
export { OpenAIChat, PromptLayerOpenAIChat } from "./openai-chat.d.ts";
