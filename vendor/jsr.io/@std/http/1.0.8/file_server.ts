...
import { join as posixJoin } from "jsr:@std/path@^1.0.6/posix/join";
import { normalize as posixNormalize } from "jsr:@std/path@^1.0.6/posix/normalize";
import { extname } from "jsr:@std/path@^1.0.6/extname";
import { join } from "jsr:@std/path@^1.0.6/join";
import { relative } from "jsr:@std/path@^1.0.6/relative";
...
import { ByteSliceStream } from "jsr:@std/streams@^1.0.7/byte-slice-stream";
