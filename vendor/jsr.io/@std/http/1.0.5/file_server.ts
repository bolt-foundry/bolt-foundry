...
import { join as posixJoin } from "jsr:@std/path@^1.0.4/posix/join";
import { normalize as posixNormalize } from "jsr:@std/path@^1.0.4/posix/normalize";
import { extname } from "jsr:@std/path@^1.0.4/extname";
import { join } from "jsr:@std/path@^1.0.4/join";
import { relative } from "jsr:@std/path@^1.0.4/relative";
import { resolve } from "jsr:@std/path@^1.0.4/resolve";
import { SEPARATOR_PATTERN } from "jsr:@std/path@^1.0.4/constants";
...
import { ByteSliceStream } from "jsr:@std/streams@^1.0.4/byte-slice-stream";
import { parseArgs } from "jsr:@std/cli@^1.0.5/parse-args";
import denoConfig from "./deno.json" with { type: "json" };
import { format as formatBytes } from "jsr:@std/fmt@^1.0.2/bytes";
import { getNetworkAddress } from "jsr:@std/net@^1.0.2/get-network-address";
