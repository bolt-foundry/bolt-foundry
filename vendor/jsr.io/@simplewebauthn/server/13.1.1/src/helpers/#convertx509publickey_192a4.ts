import { AsnParser } from 'npm:@peculiar/asn1-schema@^2.3.8';
import { Certificate } from 'npm:@peculiar/asn1-x509@^2.3.8';
import { ECParameters, id_ecPublicKey, id_secp256r1, id_secp384r1 } from 'npm:@peculiar/asn1-ecc@^2.3.8';
import {
  COSECRV,
  COSEKEYS,
  COSEKTY,
...
import { RSAPublicKey } from 'npm:@peculiar/asn1-rsa@^2.3.8';
