import { AzureOpenAI, OpenAI } from '../../index.ts';
import { OpenAIError } from '../../error.ts';
import * as Core from '../../core.ts';
import type { RealtimeClientEvent, RealtimeServerEvent } from '../../resources/beta/realtime/realtime.ts';
import { OpenAIRealtimeEmitter, buildRealtimeURL, isAzure } from './internal-base.ts';
